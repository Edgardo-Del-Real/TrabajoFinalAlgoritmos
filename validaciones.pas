...
PROCEDURE INGRESAR_CLAVE (VAR RAIZLEGAJO,RAIZAPYNOM:T_PUNT_ARBOL; VAR POS:INTEGER);
PROCEDURE VALIDACION_CLAVE(VAR RESPUESTA: STRING; VAR POS: INTEGER;RAIZLEGAJO, RAIZAPYNOM: T_PUNT_ARBOL);
...
BEGIN
  ...
  BEGIN
    ...
    INGRESAR_CLAVE(RAIZLEGAJO, RAIZAPYNOM, POS);
    IF POS = -1 THEN
    BEGIN
      CLRSCR;
      GOTOXY(10,9);
      ...
      GOTOXY(20,14);
      TEXTCOLOR(WHITE);
      WRITELN('¿ESTÁ INTENTANDO INGRESAR UN NUEVO CONDUCTOR? O ¿HUBO ALGÚN ERROR CON LA CLAVE?');
      GOTOXY(20,16);
      WRITE('SI DESEA CARGAR UN NUEVO CONDUCTOR, ');
      TEXTCOLOR(LIGHTBLUE);
      WRITE('PRESIONE S');
      GOTOXY(20,18);
      TEXTCOLOR(WHITE);
