...
VAR
   ...
   BEGIN
     ...
     TEXTCOLOR(GREEN);
     GOTOXY(45,10);
     WRITE('INGRESE FECHA DE INICIO DD/MM/AAAA: ');
     TEXTCOLOR(WHITE);
     READLN(FECHA_INICIO);
     FI:=CONVERTIR_FECHA(FECHA_INICIO);
     TEXTCOLOR(GREEN);
     GOTOXY(45,12);
     WRITE('INGRESE FECHA DE FIN DD/MM/AAAA: ');
     TEXTCOLOR(WHITE);
     READLN(FECHA_FIN);
...
BEGIN
  ...
  REPEAT
    ...
    BEGIN
      ...
      GOTOXY(43,17);
      WRITELN(' ES DE ', CANTIDAD_ALUMNOS_DISCAPACIDAD(ARCH,RES), ' SOBRE UN TOTAL DE ', FILESIZE(ARCH), ' ALUMNOS');
      READKEY;
    END;
  UNTIL SALIR;
  CLRSCR;
